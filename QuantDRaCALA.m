...
%% QuantDRaCALA: main program to run QuantDRaCALA analysis
...
%
% Usage:
%   [QD, bs] = QuantDRaCALA(numC, maxPCA, scaleSize, setPct, trnSize, DataSet, sv, vis)
%
% Input:
...
if ~strcmpi(class(DataSet), 'BoardSet')
    ...
    if DataSet
        pth = '/home/yan-yan11/Dropbox/EdSpalding_Lab/Software/QD2/QuantDRaCALA/SampleData';
%         pth = '/home/jbustamante/Software/QuantDRaCALA/SampleData';
        bnm = getDirName(pth);
